...
router.get('/confirmed', validationMiddleware(ListConfirmedReportsRequest), listConfirmedReports)
router.get('/mine', validationMiddleware(ListMyReportsRequest), listMyReports)
